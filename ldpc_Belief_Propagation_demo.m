...
for grp_idx=1:dec_grp
    ...
    for iter_idx=1:iter_num
        ...
        for idx=1:m
            ...
            if(dec_mode==0)
                C(idx,1) = 2*atanh(tanh(V(C2V_slct(idx,2),new_idx_2)/2)*tanh(V(C2V_slct(idx,3),new_idx_3)/2));
                C(idx,2) = 2*atanh(tanh(V(C2V_slct(idx,1),new_idx_1)/2)*tanh(V(C2V_slct(idx,3),new_idx_3)/2));
                C(idx,3) = 2*atanh(tanh(V(C2V_slct(idx,1),new_idx_1)/2)*tanh(V(C2V_slct(idx,2),new_idx_2)/2));
            else
